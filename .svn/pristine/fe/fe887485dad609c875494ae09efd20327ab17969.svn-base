...
<body class="d-flex flex-column">
  ...
  <div class="page-class">
    ...
    <%@ include file="/WEB-INF/pages/main/admin/code/modal/edit-modal-class.jsp"%>
    <%@ include file="/WEB-INF/pages/main/admin/code/modal/create-modal-class.jsp"%>
    <script src="${path}/resources/js/main/user/auth.js"></script>
    <script src="${path}/resources/js/main/admin/classification.js"></script>
