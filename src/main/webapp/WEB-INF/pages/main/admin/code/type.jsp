...
<body class="d-flex flex-column">
  ...
  <div class="page-type">
    ...
    <div class="page-wrapper">
      ...
      <div class="page-body">
        <div class="container-xl">
          <div class="card" id="type-list-card">
            <div class="card-header d-flex justify-content-between align-items-center">
              ...
              <span class="text-muted">Total: <span id="type-count"></span></span>
    ...
    <%@ include file="/WEB-INF/pages/main/admin/code/modal/edit-modal-type.jsp"%>
    <%@ include file="/WEB-INF/pages/main/admin/code/modal/create-modal-type.jsp"%>
    <script src="${path}/resources/js/main/user/auth.js"></script>
    <script src="${path}/resources/js/main/admin/type.js"></script>
