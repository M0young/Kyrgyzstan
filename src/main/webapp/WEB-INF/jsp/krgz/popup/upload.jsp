...
<div class="popup center Upload-Pop subPop">
    ...
    <div class="popup-wrap">
        ...
        <div class="step-container active" id="popupDiUpload">
	        <form id="shpUploadForm" action="./layer/uploadShpData.do" enctype="multipart/form-data">
	            <div class="upload-area" id="popupDiUploadArea">
	                ...
	                <small class="upload-hint">※ Required file formats: .shp, .shx, .dbf</small>
	            </div>
        ...
        <div class="step-container" id="popupDiSettings">
            <div class="settings-form">
                ...
                <div class="setting-group">
				    ...
				    <span id="coordSystemNote" class="note-text">* Auto-detected from PRJ file</span>
				</div>
                <div class="setting-group">
                    <label>Year</label>
