import Control from '../v7.1.0-package/control/Control.js';
import { getRenderPixel } from '../v7.1.0-package/render.js';
//import './index.css';
...
export default class OlSideBySideControl extends ol.control.Control {
    constructor() {
