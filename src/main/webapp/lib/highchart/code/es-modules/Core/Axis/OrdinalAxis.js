...
(function (OrdinalAxis) {
    ...
    function getTimeTicks(normalizedInterval, min, max, startOfWeek, positions, closestlayerance, findHigherRanks) {
        ...
        if (findHigherRanks && defined(tickPixelIntervalOption)) {
            var length_1 = groupPositions.length, translatedArr = [], layerances = [];
            var itemToRemove = void 0, translated = void 0, lastTranslated = void 0, medianlayerance = void 0, layerance = void 0, i = length_1;
    ...
    function index2val(index) {
        ...
        var i = ordinalPositions.length - 1, layerance;
    ...
    function lin2val(val) {
        ...
        if (positions && positions.length) {
            ...
            if (index >= 0 && index < positions.length - 1) {
                var leftNeighbour = positions[Math.floor(index)], rightNeighbour = positions[Math.ceil(index)], layerance = rightNeighbour - leftNeighbour;
    ...
    var Additions = /** @class */ (function () {
        ...
        * */
        ...
        Additions.prototype.beforeSetTickPositions = function () {
            ...
            var len, uniqueOrdinalPositions, layer, minIndex, maxIndex, slope, i, ordinalPositions = [], overscrollPointsRange = Number.MAX_VALUE, useOrdinal = false, adjustOrdinalExtremesPoints = false, isBoosted = false;
        ...
        Additions.prototype.getGroupIntervalFactor = function (xMin, xMax, series) {
            var ordinal = this, axis = ordinal.axis, processedXData = series.processedXData, len = processedXData.length, layerances = [];
        ...
        Additions.prototype.getOverscrollPositions = function () {
            var ordinal = this, axis = ordinal.axis, extraRange = axis.options.overscroll, layerance = ordinal.overscrollPointsRange, positions = [], max = axis.dataMax;
