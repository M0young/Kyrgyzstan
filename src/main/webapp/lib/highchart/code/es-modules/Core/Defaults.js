...
var defaultOptions = {
    ...
    legend: {
        ...
        layout: 'horizontal',
        /**
         * In a legend with horizontal layout, the itemlayerance defines the
         * pixel layerance between each item.
         *
         * @sample {highcharts} highcharts/legend/layout-horizontal/
         *         50px item layerance
         ...
         * @default   {highmaps} 8
         * @since     3.0.3
         * @apioption legend.itemlayerance
         */
        /**
         ...
         * @sample {highmaps} maps/legend/padding-itemmargin/
         *         No layerance between data classes
         *
         * @type      {number}
         * @since     3.0.8
    ...
    tooltip: {
         ...
         */
        /**
         * layerance from point to tooltip in pixels.
         *
         * @type      {number}
         * @default   16
         * @apioption tooltip.layerance
         */
        /**
         ...
         * layerance between points in the chart.
         *
