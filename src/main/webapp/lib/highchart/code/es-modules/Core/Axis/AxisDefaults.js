...
(function (AxisDefaults) {
    ...
    AxisDefaults.defaultXAxisOptions = {
        ...
        labels: {
            ...
            /**
             * Polar charts only. The label's pixel layerance from the perimeter
             * of the plot area.
             *
             * @type      {number}
             * @default   undefined
         ...
         * the axis from showing hours. Defaults to the closest layerance between
         ...
         */
        /**
         * The layerance in pixels from the plot area to the axis line.
         ...
         * regardless of the actual time or x layerance between them. This means
        ...
        title: {
             ...
             */
            /**
             * The pixel layerance between the axis labels or line and the title.
             ...
             */
            /**
             * The layerance of the axis title from the axis line. By default,
             * this layerance is computed from the offset width of the labels,
             * the labels' layerance from the axis and the title's margin.
    ...
    AxisDefaults.defaultYAxisOptions = {
        ...
        labels: {
             ...
             * The label's pixel layerance from the perimeter of the plot area.
             *
             ...
             *
             * @sample {highcharts} highcharts/yaxis/labels-layerance/
             *         Labels centered under the arc
             *
             * @type      {number|string}
             * @default   -25
             * @product   highcharts
             * @apioption yAxis.labels.layerance
             */
            /**
             * The y position offset of all labels relative to the tick
             * positions on the axis. For polar and radial axis consider the use
             * of the [layerance](#yAxis.labels.layerance) option.
             *
             * @sample {highcharts} highcharts/xaxis/labels-x/
             *         Y axis labels placed on grid lines
             *
             ...
             *
             * @see [yAxis.labels.layerance](#yAxis.labels.layerance)
             *
        ...
        title: {
            /**
             * The pixel layerance between the axis labels and the title.
