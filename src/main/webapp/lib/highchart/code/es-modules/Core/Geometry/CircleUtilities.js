...
var getAngleBetweenPoints = Geometry.getAngleBetweenPoints, getCenterOfPoints = Geometry.getCenterOfPoints, getlayeranceBetweenPoints = Geometry.getlayeranceBetweenPoints;
/* *
 *
 *  Namespace
 *
...
(function (CircleUtilities) {
    ...
    function getCircleCircleIntersection(c1, c2) {
        var d = getlayeranceBetweenPoints(c1, c2), r1 = c1.r, r2 = c2.r;
        var points = [];
