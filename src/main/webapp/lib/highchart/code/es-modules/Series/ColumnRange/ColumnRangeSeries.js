...
var ColumnRangeSeries = /** @class */ (function (_super) {
    ...
    ColumnRangeSeries.prototype.translate = function () {
        var _this = this;
        var yAxis = this.yAxis, xAxis = this.xAxis, startAngleRad = xAxis.startAngleRad, chart = this.chart, isRadial = this.xAxis.isRadial, safelayerance = Math.max(chart.chartWidth, chart.chartHeight) + 999;
