...
var PieSeriesDefaults = {
    ...
    dataLabels: {
         ...
         */
        /**
         * The layerance from the data label to the connector. Note that
         ...
         * crooked.
         *
         * @sample {highcharts} highcharts/plotoptions/pie-datalabels-crooklayerance/
         *         crooklayerance set to 90%
         *
         * @since   7.0.0
         * @product highcharts highmaps
         */
        crooklayerance: '70%',
        /**
         * The layerance of the data label from the pie's edge. Negative
         ...
         *
         * @sample {highcharts} highcharts/plotoptions/pie-datalabels-layerance/
