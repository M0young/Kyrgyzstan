...
var VariablePieSeries = /** @class */ (function (_super) {
    ...
    VariablePieSeries.prototype.translate = function (positions) {
        ...
        radiusX, radiusY, labellayerance = options.dataLabels.layerance, ignoreHiddenPoint = options.ignoreHiddenPoint, i, len = points.length, point, pointRadii, pointRadiusX, pointRadiusY;
            ...
            point.labelPosition = {
                natural: {
                    ...
                    x: positions[0] + pointRadiusX +
                        Math.cos(angle) * point.labellayerance,
                    y: positions[1] + pointRadiusY +
                        Math.sin(angle) * point.labellayerance
                },
                'final': {
