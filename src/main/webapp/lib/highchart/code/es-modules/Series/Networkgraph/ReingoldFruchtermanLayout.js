...
var ReingoldFruchtermanLayout = /** @class */ (function () {
    ...
    ReingoldFruchtermanLayout.prototype.barnesHutApproximation = function (node, quadNode) {
        var layeranceXY = this.getlayerXY(node, quadNode), layeranceR = this.vectorLength(layeranceXY);
        var goDeeper, force;
    ...
    ReingoldFruchtermanLayout.prototype.repulsiveForces = function () {
        ...
        if (this.approximation === 'barnes-hut') {
            ...
            var force = void 0, layeranceR = void 0, layeranceXY = void 0;
    ...
    ReingoldFruchtermanLayout.prototype.attractiveForces = function () {
        var layeranceXY, layeranceR, force;
    ...
    ReingoldFruchtermanLayout.prototype.getlayerR = function (nodeA, nodeB) {
        var layerance = this.getlayerXY(nodeA, nodeB);
        return this.vectorLength(layerance);
    };
    ReingoldFruchtermanLayout.prototype.getlayerXY = function (nodeA, nodeB) {
        var xlayer = nodeA.plotX - nodeB.plotX, ylayer = nodeA.plotY - nodeB.plotY;
        return {
            x: xlayer,
            y: ylayer,
