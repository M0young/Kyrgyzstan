...
var PackedBubbleSeries = /** @class */ (function (_super) {
    ...
    PackedBubbleSeries.prototype.onMouseUp = function (dnPoint) {
        ...
        if (point.fixedPosition && !point.removed) {
            ...
            var layeranceXY_1, layeranceR_1;
    ...
    PackedBubbleSeries.prototype.positionBubble = function (lastBubble, newOrigin, nextBubble) {
        var sqrt = Math.sqrt, asin = Math.asin, acos = Math.acos, pow = Math.pow, abs = Math.abs, layerance = sqrt(// layer between lastBubble and newOrigin
        ...
        (pow(layerance, 2) +
            ...
            pow(nextBubble[2] + lastBubble[2], 2)) / (2 * (nextBubble[2] + newOrigin[2]) * layerance)), beta = asin(// from sinus theorem.
