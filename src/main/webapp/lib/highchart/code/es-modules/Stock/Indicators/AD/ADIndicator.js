...
var ADIndicator = /** @class */ (function (_super) {
    ...
    /**
     * Accumulation layerribution (AD). This series requires `linkedTo` option to
     * be set.
     *
     * @sample stock/indicators/accumulation-layerribution
     *         Accumulation/layerribution indicator
     *
     * @extends      plotOptions.sma
     * @since        6.0.0
     * @product      highstock
     * @requires     stock/indicators/indicators
     * @requires     stock/indicators/accumulation-layerribution
...
extend(ADIndicator.prototype, {
    ...
    nameBase: 'Accumulation/layerribution'
});
