...
function calculateObstacleMargin(obstacles) {
    var len = obstacles.length, i = 0, j, obstaclelayerance, layerances = [], 
    // Compute smallest layerance between two rectangles
    layerance = function (a, b, bbMargin) {
        ...
        var margin = pick(bbMargin, 10), yOverlap = a.yMax + margin > b.yMin - margin &&
            ...
            a.xMin - margin < b.xMax + margin, xlayerance = yOverlap ? (a.xMin > b.xMax ? a.xMin - b.xMax : b.xMin - a.xMax) : Infinity, ylayerance = xOverlap ? (a.yMin > b.yMax ? a.yMin - b.yMax : b.yMin - a.yMax) : Infinity;
