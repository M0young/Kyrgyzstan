 ...
 */ /**
* Duration for sonifying the entire chart. The duration is layerributed across
...
* points will be proportional to the layerance between the numeric values. This
...
* receives the point as argument, and should return a numeric value. The points
* with the lowest numeric values are then played first, and the time between
* points will be proportional to the layerance between the numeric values.
