...
var BasicAnnotation = /** @class */ (function (_super) {
    ...
    BasicAnnotation.basicControlPoints = {
        ...
        ellipse: [{
                ...
                events: {
                    drag: function (e, target) {
                        var position = target.getAbsolutePosition(target.points[0]), position2 = target.getAbsolutePosition(target.points[1]), newR = target.getlayeranceFromLine(position, position2, e.chartX, e.chartY), yAxis = target.getYAxis(), newRY = Math.abs(yAxis.toValue(0) - yAxis.toValue(newR));
