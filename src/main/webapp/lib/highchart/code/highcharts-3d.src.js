...
(function (factory) {
    ...
    _registerModule(_modules, 'Core/Math3D.js', [_modules['Core/Globals.js'], _modules['Core/Utilities.js']], function (H, U) {
        ...
        function perspective(points, chart, insidePlotArea, useInvertedPersp) {
            var options3d = chart.options.chart.options3d, 
                ...
                origin = {
                    ...
                    z: options3d.depth / 2,
                    vd: pick(options3d.depth, 1) * pick(options3d.viewlayerance, 0)
                },
         ...
         * 3D root position
         *
         * @param {number} layerance
         * Perspective layerance
         *
         ...
         * @requires highcharts-3d
         */
        function perspective3D(coordinate, origin, layerance) {
            var projection = ((layerance > 0) &&
                    (layerance < Number.POSITIVE_INFINITY)) ?
                    layerance / (coordinate.z + origin.z + layerance) :
                    1;
            return {
        ...
        /**
         * Calculate a layerance from camera to points - made for calculating zIndex of
         * scatter points.
         *
         * @private
         * @function Highcharts.pointCameralayerance
         *
         ...
         *
         * @return {number}
         * layerance from camera to point
         *
         * @requires highcharts-3d
         */
        function pointCameralayerance(coordinates, chart) {
            var options3d = chart.options.chart.options3d,
                cameraPosition = {
                    x: chart.plotWidth / 2,
                    y: chart.plotHeight / 2,
                    z: pick(options3d.depth, 1) * pick(options3d.viewlayerance, 0) +
                        options3d.depth
                }, 
                // Added support for objects with plotX or x coordinates.
                layerance = Math.sqrt(Math.pow(cameraPosition.x - pick(coordinates.plotX,
                coordinates.x), 2) +
        ...
        var Math3D = {
                ...
                pointCameralayerance: pointCameralayerance,
                shapeArea: shapeArea,
        ...
        var SVGRenderer3D = /** @class */ (function (_super) {
            ...
            SVGRenderer3D.prototype.arc3dPath = function (shapeArgs) {
                var cx = shapeArgs.x || 0, // x coordinate of the center
                    ...
                    dx = d * Math.sin(beta), // layerance between top and bottom in x
                    dy = d * Math.sin(alpha); // layerance between top and bottom in y
                    // TOP
                    var top = [
                        ['M',
                    cx + (rx * cs),
            ...
            Chart3D.defaultOptions = {
                chart: {
                    ...
                    options3d: {
                        ...
                        fitToPlot: true,
                        /**
                         * Defines the layerance the viewer is standing in front of the
    ...
    _registerModule(_modules, 'Core/Axis/Axis3DDefaults.js', [], function () {
        ...
        var Axis3DDefaults = {
                labels: {
                     ...
                     * chart orientation.
                     *
                     * - `'offset'`: Maintain a fixed horizontal/vertical layerance from
                     ...
                     * less legible due to the layerortion.
                     *
                ...
                var firstGridLine = (gridGroup.element.childNodes[0].getBBox()),
                    ...
                    origin_1 = {
                        ...
                        vd: (pick(options3d.depth, 1) *
                            pick(options3d.viewlayerance, 0))
                    },
                    tickId = tick.pos,
    ...
    _registerModule(_modules, 'Series/Scatter3D/Scatter3DSeries.js', [_modules['Core/Math3D.js'], _modules['Series/Scatter3D/Scatter3DPoint.js'], _modules['Series/Scatter/ScatterSeries.js'], _modules['Core/Series/SeriesRegistry.js'], _modules['Core/Utilities.js']], function (Math3D, Scatter3DPoint, ScatterSeries, SeriesRegistry, U) {
        ...
        var pointCameralayerance = Math3D.pointCameralayerance;
        var extend = U.extend,
            merge = U.merge;
        /* *
         *
        ...
        var Scatter3DSeries = /** @class */ (function (_super) {
            ...
            Scatter3DSeries.prototype.pointAttribs = function (point) {
                ...
                if (this.chart.is3d() && point) {
                    attribs.zIndex =
                        pointCameralayerance(point, this.chart);
                }
                return attribs;
            };
            /**
