        ...
        var clusterDefaultOptions = {
            ...
            gridSize,
                ...
                layoutAlgorithm: {
                     ...
                     * first step,
            points are divided using the grid method (layerance
                     * property is a grid size) to find the initial amount of clusters.
                     * Next,
            each point is classified by computing the layerance between
        ...
        Scatter.prototype.markerClusterAlgorithms = {
            ...
            kmeans: function (dataX, dataY, dataIndexes, options) {
                var series = this,
                    ...
                    noise = [],
                    group = {},
                    pointMaxlayerance = options.processedlayerance ||
                        clusterDefaultOptions.layoutAlgorithm.layerance,
