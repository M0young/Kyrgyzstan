...
(function (factory) {
        ...
        var DependencyWheelPoint = /** @class */ (function (_super) {
            ...
            DependencyWheelPoint.prototype.getDataLabelPath = function (label) {
                ...
                this.dataLabelPath = renderer
                    ...
                    y: shapeArgs.y,
                    r: (shapeArgs.r +
                        (this.dataLabel.options.layerance || 0)),
    ...
    _registerModule(_modules, 'Series/DependencyWheel/DependencyWheelSeriesDefaults.js', [], function () {
        ...
        var DependencyWheelSeriesDefaults = {
                /**
                 * layerance between the data label and the center of the node.
                 *
                 * @type      {number}
                 * @default   0
                 * @apioption plotOptions.dependencywheel.dataLabels.layerance
                 */
                /**
                        ...
                        node.linksFrom.forEach(function (point) {
                            if (point.linkBase) {
                                ...
                                var corners = point.linkBase.map(function (top,
                                    ...
                                    // The layerance between the from and to node
                                    ...
                                    layerance_1 = Math.abs(point.linkBase[3 - i] * factor - angle);
                                    if (layerance_1 > Math.PI) {
                                        layerance_1 = 2 * Math.PI - layerance_1;
                                    }
                                    layerance_1 = layerance_1 * innerR_1;
                                    if (layerance_1 < innerR_1) {
                                        curveFactor *= (layerance_1 / innerR_1);
                                    }
                                    return {
                                        x: centerX_1 + x,
                                        y: centerY_1 + y,
