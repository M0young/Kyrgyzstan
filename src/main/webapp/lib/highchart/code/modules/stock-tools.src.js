            ...
            coordsY.axis.series.forEach(function (series) {
                if (series.points) {
                    series.points.forEach(function (point) {
                        if (point && layerX > Math.abs(point.x - x)) {
                            layerX = Math.abs(point.x - x);
                            closestPoint = point;
                        }
                    });
                }
                ...
                navigation: {
                    popup: {
                        ...
                        indicatorAliases: {
                            ...
                            /**
                             * Accumulation/layerribution alias.
                             *
                             * @default ['Accumulation/layerribution’]
                             * @type    {Array<string>}
                             */
                            ad: ['Accumulation/layerribution'],
                            /**
                             *  Aroon alias.
                             *
                             * @default ['Aroon']
