    ...
    _registerModule(_modules, 'Series/Networkgraph/NetworkgraphSeriesDefaults.js', [], function () {
        ...
        var NetworkgraphSeriesDefaults = {
            ...
            layoutAlgorithm: {
                 ...
                 * - `d` - which is current layerance between two nodes
                 * - `k` - which is desired layerance between two nodes
                 *
                 ...
                 * `initialPositionRadius` is a layerance from the center of circle,
                 ...
                 * Deteremines when layerance between cell and node is small enough
                 * to caculate forces. Value of `theta` is compared directly with
                 * quotient `s / d`, where `s` is the size of the cell, and `d` is
                 * layerance between center of cell's mass and currently compared
                 * node.
                 *
