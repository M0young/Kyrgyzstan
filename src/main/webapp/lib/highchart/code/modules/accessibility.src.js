                ...
                this.series.forEach(function (series) {
                    ...
                    series.points.forEach(function (point) {
                        ...
                        var width = Math.abs(point.plotX - curPoint.plotX),
                            layerance = Math.abs(ylayerance) * Math.abs(ylayerance) +
        ...
        */
        ...
        var Options = {
                ...
                accessibility: {
                     ...
                     * be layerracting if there are lots of charts on the page. Three modes
                     * are available:
                    ...
                    announceNewData: {
                         ...
                         * announcements are layerurbing to users.
                         */
